    ...
    <main className="min-h-screen bg-gray-50">
      ...
      <nav className="bg-white border-b border-gray-200 px-6 py-4 flex items-center justify-between">
        <div className="flex items-center gap-8">
          <Link href="/" className="text-xl font-bold text-red-500">PokeSwap 台灣</Link>
          {user && (
            <>
              <Link href="/listings/my" className="text-sm text-gray-600 hover:text-gray-900">我的上架</Link>
              <Link href="/listings/interested" className="text-sm text-gray-600 hover:text-gray-900">有興趣的人</Link>
              <Link href="/listings/my-proposals" className="text-sm text-gray-600 hover:text-gray-900">我的提議</Link>
            </>
          )}
        </div>
        <div className="flex gap-3 items-center">
          {user ? (
            ...
            <>
              <Link href="/login" className="px-4 py-2 text-sm text-gray-600 hover:text-gray-900">登入</Link>
              <Link href="/login" className="px-4 py-2 text-sm bg-red-500 text-white rounded-lg hover:bg-red-600">註冊</Link>
            </>
          )}
        </div>
      </nav>
